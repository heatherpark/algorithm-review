...
time complexity: O(log n) because in the worst case, you have to check log n
(where n is the size of the input list) elements.

example: if you have a list of 8 elemeents, you have to check 3 elements, at most, because
